...
This document describes the migration from the web component-based API to the new JavaScript API for `@datairis/render`.
...
```javascript
import {MalloyRenderer} from '@datairis/render';
...
import {HTMLView, JSONView, getDataTree} from '@datairis/render';
```
